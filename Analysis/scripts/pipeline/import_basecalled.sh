...
export MINION_PC_EXP_NAME="25_01_24_01_250821_1"
export INTI_EXP_NAME="25012401_DSUP2_1"
...
for i in $(seq 1 9)
do
    cat barcode0$i/* > barcode0$i.fastq.gz
done 
for i in $(seq 10 12)
do
    cat barcode$i/* > barcode$i.fastq.gz
done
cat unclassified/* > unclassified.fastq.gz
...
for i in $(seq 1 9)
do
    gunzip barcode0$i.fastq.gz
done
for i in $(seq 10 12)
    do gunzip barcode$i.fastq.gz
done
gunzip unclassified.fastq.gz
