...
#MSUB -o ${CAPASVIR_ANALYSIS}/temp/blasting_unexpected_reads/logs/blastn.%I.out     # Output log file name (%I is the job ID)
#MSUB -e ${CAPASVIR_ANALYSIS}/temp/blasting_unexpected_reads/logs/blastn.%I.err     # Error log file name (%I is the job ID)
#MSUB -E'--mem=300G --qos=long'

module load blast+/2.16.0
test_dir="${CAPASVIR_ANALYSIS}/temp/blasting_unexpected_reads"
my_seq="test_barcode05_unmapped_selection_no_GA"

# Set path to Blast nt local DB

BLASTDB="${CAPASVIR_ANALYSIS}/Data/blast_db/nt"
export BLASTDB="${CAPASVIR_ANALYSIS}/Data/blast_db/nt"
