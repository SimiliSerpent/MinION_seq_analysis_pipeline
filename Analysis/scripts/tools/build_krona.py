...
analysis_repo = os.environ['CAPASVIR_ANALYSIS']
tax_file=f'{analysis_repo}/Data/taxonomy.tab'
...
def convert_to_krona(report, outdir):
  ...
  if not os.path.exists(report + ".html"):
    ...
    cmd = [
      f'{analysis_repo}/Analysis/scripts/KronaTools-2.8.1/bin/ktImportText',
